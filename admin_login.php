...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check the users table for admin
    $query = $conn->prepare("SELECT id, username, password, usertype FROM users WHERE email = ? OR username = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            if ($user['usertype'] === 'admin') {
                ...
                echo "Access denied: Only admin users can log in.";
                exit();
            }
        } else {
                ...
                <div class="form-content">
                    ...
                    <div class="form-fields">
                        ...
                        <p style="margin-top: 15px;">Don't have an account? 
                            <a href="admin_register.php" style="color: #1e90ff; text-decoration: none; font-weight: bold;">Register here</a></p>
